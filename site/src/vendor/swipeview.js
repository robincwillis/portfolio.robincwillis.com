...
var SwipeView = (function (window, document) {
	var dummyStyle = document.createElement('div').style,
		...
		SwipeView = function (el, options) {
			...
			div.style.cssText = 'position:relative;top:0;left:0;height:100%;width:100%;' + cssVendor + 'transition-duration:0;' + cssVendor + 'transform:translateZ(0);' + cssVendor + 'transition-timing-function:ease-out';
			...
			for (i=-1; i<2; i++) {
				...
				div.style.cssText = cssVendor + 'transform:translateZ(0);position:absolute;top:0;left:0;height:100%;width:100%;left:' + i*100 + '%';
